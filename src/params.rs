...
pub(crate) const GAP: u16 = 10;
pub(crate) const GAP2: u16 = GAP * 2;
pub(crate) const SPACE: u16 = GAP / 2;
pub(crate) const SPACE2: u16 = GAP;
...
pub(crate) const NOTICE_SIZE: u16 = 24;

pub(crate) const CONTAINER_WIDTH: u32 = 800;
